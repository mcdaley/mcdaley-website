  ...
  return (
    <>
      <footer className="grid grid-cols-2 border-t border-gray-300 mt-8">
        <div id="sitemap" className="flex flex-col my-4">
        ...
        <div id="contact" className="flex flex-col my-4">
          ...
          <div className="inline-flex mb-4 items-center">
            <Link href="https://github.com/mcdaley">
              <a target="_blank">
                <svg
                  viewBox   = '0 0 24 24'
                  xmlns     = 'http://www.w3.org/2000/svg'
                  className = 'fill-current text-gray-400 h-8 w-8 mr-2'
                >
            ...
            <Link href="https://linkedin.com/in/mcdaley">
              <a target="_blank">
                <svg
                  viewBox   = '0 0 24 24'
                  xmlns     = 'http://www.w3.org/2000/svg'
